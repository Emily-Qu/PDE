...
if __name__ == "__main__":
    ...
    t = data['tt'].T.flatten()[:,None]     # (T, 1) = (201,1)
    #print(t.shape)
    ...
    ax.plot(x, Exact_h[49,:], 'b-', linewidth = 2, label = 'Exact')
    ax.plot(x, H_pred[49,:], 'r--', linewidth = 2, label = 'Prediction')
    ax.set_xlabel('$x$')
    ax.set_ylabel('$u(t,x)$')
