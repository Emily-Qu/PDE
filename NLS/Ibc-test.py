...
class PhysicsInformedNN():
    ...
    def set_training_data(self, x0, u0, v0, tb, Xf):
        ...
        self.t0 = torch.full_like(self.x0, -5.0).to(device)
...
if __name__ == "__main__":
    ...
    data = scipy.io.loadmat(os.path.join(current_dir, 'data', 'GNSS-2soliton.mat'))
    ...
    #         logfilename = f"log-bcPINN{i}.txt"
    ...
    fig.savefig(os.path.join(current_dir, 'png', 'testbcGnSS.png'))
    plt.show()
