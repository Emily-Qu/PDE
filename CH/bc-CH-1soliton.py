...
class PhysicsInformedNN():
    ...
    def net_f(self, x, t):  # 在backward中调用
        ...
        return u_t - u_xxt + 3*u*u_x -2*u_xx*u_x + 2*u_x -u_xxx*u
...
if __name__ == "__main__":
    ...
    #随机选择边界时间点
        ...
        if counter == 0:
            ...
            logfilename = f"log-bc{i}_1sol.txt"
    ...
    # 保存模型
        ...
        model_name = f"model_segment_{i}_1sol.pth"
    ...
    model_name = "model_segment_3_1sol.pth"
...
# ---- 右图：误差图 Error = |Exact - Pred| ----
    ...
    fig.savefig(os.path.join(current_dir, 'png', 'bc CH1sol.png'))
    plt.show()
