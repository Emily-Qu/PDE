...
if __name__ == "__main__":
    ...
    #         logfilename = f"log-bc53[-0.5,1][-15,20]_{i}.txt"
    ...
    #     model_name = f"bc53[-0.5,1][-15,20]_{i}.pth"
    ...
    model_name = "bc53[-0.5,1][-15,20]_3.pth"
...
# ---- 右图：误差图 Error = |Exact - Pred| ----
    ...
    ax.set_aspect( (20 - (-15)) / (0.4 - 0), adjustable='box' )
    ...
    fig.savefig(os.path.join(current_dir, 'png', 'bc 53[-0.5,1][-15,20].png'))
    plt.show()
