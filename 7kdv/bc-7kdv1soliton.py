...
if __name__ == "__main__":
    ...
    #     model_name = f"model_segment_{i}_1t-2.pth"
    ...
    model_name = "model_segment_3_1t-2.pth"
    ...
    lb = np.array([-10.0, -2.0])
    ub = np.array([10.0, 2.0])
    ...
    gs0.update(top=1-0.06, bottom=1-1/3, left=0.1, right=0.9, wspace=0.4)
...
# ---- 右图：误差图 Error = |Exact - Pred| ----
    ...
    ax.set_aspect( (10 - (-10)) / (0.6 - 0), adjustable='box' )
    ...
    fig.savefig(os.path.join(current_dir, 'png', 'bc 7kdv1soliton.png'))
    plt.show()
