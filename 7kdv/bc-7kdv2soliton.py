...
if __name__ == "__main__":
    ...
    #         temp_lb = np.array([-15, np.min(t_seg)])
    ...
    #         logfilename = "log-bc 2sol-t-0.5.txt"
    ...
    #         logfilename = f"log-bcPINN{i}_2sol-t-0.5.txt"
    ...
    lb = np.array([-15.0, -0.5])
    ub = np.array([15.0, 0.5])
...
# ---- 右图：误差图 Error = |Exact - Pred| ----
    ...
    ax.set_aspect( (15 - (-15)) / (14 - 0), adjustable='box' )
    ...
    fig.savefig(os.path.join(current_dir, 'png', 'bc 72-t-0.5.png'))
    plt.show()
