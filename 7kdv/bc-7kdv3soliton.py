...
if __name__ == "__main__":
    ...
    #         logfilename = "log-bc 3sol-t-0.5.txt"
    ...
    #         logfilename = f"log-bcPINN{i}_3sol-t-0.5.txt"
...
# ---- 右图：误差图 Error = |Exact - Pred| ----
    ...
    ax.set_aspect( (15 - (-15)) / (16 - 0), adjustable='box' )
    ...
    fig.savefig(os.path.join(current_dir, 'png', 'bc 73-t-0.5.png'))
    plt.show()
