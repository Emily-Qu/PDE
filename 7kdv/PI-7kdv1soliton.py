...
if __name__ == "__main__":
    ...
    # logfilename = "log-PI 1t-2.txt"
    # model.set_training_data(x0, u0, tb, Xf)
    # model.train(5000, logfilename)
    # model_name = "PI 1t-2.pth"
...
# ---- 右图：误差图 Error = |Exact - Pred| ----
    ...
    fig.savefig(os.path.join(current_dir, 'png', 'PI 7kdv1t-2.png'))
    plt.show()
